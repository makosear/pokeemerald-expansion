...
const u32 gTrainerFrontPic_Martgrunt[] = INCBIN_U32("graphics/trainers/front_pics/martgrunt.4bpp.lz");
const u32 gTrainerPalette_Martgrunt[] = INCBIN_U32("graphics/trainers/front_pics/martgrunt.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(MARTGRUNT, Martgrunt)
};
