...
const struct Tileset gTileset_porytiletesting =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_porytiletesting,
    .palettes = gTilesetPalettes_porytiletesting,
    .metatiles = gMetatiles_porytiletesting,
    .metatileAttributes = gMetatileAttributes_porytiletesting,
    .callback = NULL,
    .palettes_winter = gTilesetPalettes_porytiletesting_winter,
    .palettes_fall = gTilesetPalettes_porytiletesting_fall,
    .palettes_summer = gTilesetPalettes_porytiletesting_summer,
};
...
const struct Tileset gTileset_porybeach =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_porybeach,
    .palettes = gTilesetPalettes_porybeach,
    .metatiles = gMetatiles_porybeach,
