...
static const struct SpriteFrameImage sPicTable_OpenableBox[] = {
    overworld_ascending_frames(gObjectEventPic_OpenableBox, 2, 2),
};
...
static const struct SpriteFrameImage sPicTable_Sam[] = {
    overworld_ascending_frames(gObjectEventPic_Sam, 2, 4),
};

static const struct SpriteFrameImage sPicTable_MartGrunt[] = {
    overworld_ascending_frames(gObjectEventPic_MartGrunt, 2, 4),
};

static const struct SpriteFrameImage sPicTable_FarmerNormal[] = {
