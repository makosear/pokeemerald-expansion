...
// * REPLACE BRENDAN WITH FARMER SPRITE
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_FARMER_NORMAL,     OBJ_EVENT_GFX_MAY_NORMAL},
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        ...
        // * REPLACE BRENDAN WITH FARMER SPRITE
        {OBJ_EVENT_GFX_FARMER_NORMAL,      PLAYER_AVATAR_FLAG_ON_FOOT},
