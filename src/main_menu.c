...
static void Task_NewGameBirchSpeech_Init(u8 taskId)
{
    ...
    SetGpuReg(REG_OFFSET_BLDALPHA, 0);
    SetGpuReg(REG_OFFSET_BLDY, 0);
    gSaveBlock2Ptr->playerGender = MALE; //male by default
    NewGameBirchSpeech_SetDefaultPlayerName(Random() % NUM_PRESET_NAMES); //nome aleatorio
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeech_FadePlayerToWhite; //skippa
